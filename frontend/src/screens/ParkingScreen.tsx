...
export default function ParkingScreen() {
  ...
  const load = async () => { setLoading(true); try { setParking((await getParking()).parking); setError(''); } catch (loadError) { setError(loadError instanceof Error ? loadError.message : 'No se pudo cargar parqueaderos.'); } finally { setLoading(false); } };
  useEffect(() => { void load(); }, []);
